		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"text": "MIDI velocity -> color7th (M0 POC): harder hits add flat-7ths"
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"text": "MIDI EXPRESSION (M2): velocity->dynamics, mod wheel(CC1)->register, pitchbend->maj/min colour"
				}
			},
			{
				"box": {
