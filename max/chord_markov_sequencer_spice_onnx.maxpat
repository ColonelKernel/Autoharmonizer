 ...
 "patcher": {
  ...
  "boxes": [
   ...
   },
   {
    "box": {
     ...
     "text": "Chord Markov Sequencer (ONNX) \u2014 Python-free wide panel: Color/Adventure split from the Spice macro, VoiceDist and Audition restored, full readouts."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "annotation": "Corpus flavour: folk (Nottingham) -> pop (POP909) -> classical (Bach) -> jazz (Open Book). Blends the per-corpus Markov chains rather than switching between them.",
     "annotation_name": "Color"
    }
   },
   {
    "box": {
     "id": "obj-onnx-pre-color",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
   ...
   },
   {
    "box": {
     ...
     "annotation": "Sampling temperature: low picks the commonest next chord, high surfaces rare, colourful ones. Also widens/sharpens the rnn/lstm softmax.",
     "annotation_name": "Adventure"
    }
   },
   {
    "box": {
     "id": "obj-onnx-pre-adventure",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
   ...
   },
   {
    "box": {
     ...
     "annotation_name": "VoiceDist"
    }
   },
   {
    "box": {
     "id": "obj-onnx-pre-voicedist",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
   ...
   },
   {
    "box": {
     ...
     "annotation_name": "Audition"
    }
   },
   {
    "box": {
     "id": "obj-onnx-pre-audition",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
  ...
  "lines": [
   ...
   },
   {
    "patchline": {
     "destination": [
      "obj-onnx-pre-adventure",
      0
     ],
     "source": [
      "obj-onnx-dial-adventure",
      0
     ]
    }
   },
   ...
   },
   {
    "patchline": {
     "destination": [
      "obj-onnx-pre-voicedist",
      0
     ],
     "source": [
      "obj-onnx-dial-voicedist",
      0
     ]
    }
   },
