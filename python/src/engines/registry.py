...
class EngineRegistry:
    ...
    def set_neural_temperature_from_dial(self, value: float) -> None:
        ...
        with self._lock:
            ...
            rnn, lstm = self._rnn, self._lstm
        for engine in (rnn, lstm):
    ...
    def sample(self, raw_input: str) -> SampleResult:
        ...
        if result.output is not None:
            result = replace(result, output=from_jazznet(result.output))
        return result
