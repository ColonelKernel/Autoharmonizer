 ...
 "patcher": {
  ...
  "boxes": [
   {
    "box": {
     ...
     "annotation": "Generative engine. markov = corpus blend; rnn/lstm = JazzNet neural sessions; ngram = transparent variable-order harmonic context; phrase = whole-phrase generation with learned rhythm and cadence.",
   ...
   },
   {
    "box": {
     ...
     "annotation": "Harmonic vocabulary and planning depth. Low keeps diatonic triads and direct functional motion; high permits richer extensions, tonicization, mixture, substitutions and controlled modulation. Independent of Spice randomness and downstream Voicing.",
   ...
   },
   {
    "box": {
     ...
     "text": "Chord Markov Performer v4 \u2014 theory-aware Complexity control; isolated OSC 9100/9101."
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "text": "node.script markov_osc_v4.js",
     "outlettype": [
      ""
     ],
     "filename": "markov_osc_v4.js"
    }
   },
   {
    "box": {
     ...
     "text": "route status output error chord notes stop playoff rhythmname phraselenbars phrasemodename voicedistname keyname seedname modelname sessionmodename capstate sessionstat modelstat backendstate backendtext protocolstat voicecount bridgeready",
     "outlettype": [
      "",
      "",
      "",
   ...
   },
   {
    "box": {
     ...
     "text": "MIDI: notes -> flush-old -> re-latch velocity -> iter pitches -> flush -> pack -> midiformat -> midiout (held until next chord/stop)"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "saved_attribute_attributes": {
      "valueof": {
       "parameter_longname": "Relink",
       "parameter_shortname": "Relink",
       "parameter_type": 2,
       "parameter_enum": [
        "off",
        "on"
     ...
     "annotation": "Restart the Python chord engine (or launch it if it is down). The light shows engine health: green = answering, amber = starting, red = down.",
     "annotation_name": "Relink"
    }
   },
   {
    "box": {
   ...
   },
   {
    "box": {
     ...
     "annotation": "Rhythmic feel. Straight follows the Rhythm density template; Push, Tresillo, Clave and Upbeats add eighth-note or multi-bar syncopation; Triplet uses the quarter-note-triplet clock.",
     "annotation_name": "Feel"
    }
   },
   {
    "box": {
     "id": "obj-v4-pre-feelidx",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
   ...
   },
   {
    "box": {
     ...
     "annotation": "Number of distinct MIDI pitches emitted for the current chord."
    }
   },
   {
    "box": {
     "id": "obj-v4-preset-voicecount",
     "maxclass": "newobj",
     "numinlets": 1,
     "numoutlets": 1,
     "patching_rect": [
   ...
   {
    "box": {
     "id": "obj-v4-delay-startup-restore",
     "maxclass": "newobj",
     "numinlets": 2,
     "numoutlets": 1,
     "outlettype": [
  ...
  "lines": [
   ...
   },
   {
    "patchline": {
     "destination": [
      "obj-v4-pre-complexity",
      0
     ],
     "source": [
      "obj-v4-dial-complexity",
      0
     ]
    }
   },
